...
private:
  [[nodiscard]] static std::string diff(const MoveList& actual, const MoveList& expected) {
    ...
    std::copy_if(actualSet.begin(), actualSet.end(), std::inserter(extraneous, extraneous.begin()), [&](const auto& item) {
      return !expectedSet.count(item);
    });
    std::copy_if(expectedSet.begin(), expectedSet.end(), std::inserter(missing, missing.begin()), [&](const auto& item) {
      return !actualSet.count(item);
    });
...
TEST_F(MoveGenerationTest, HandlesPromotion_WhitePawn) {
  ...
  expectLegalMoves(
      "a5b6", "a7a8q", "b5a3", "b5c7", "b5d4", "b5d6", "b7b8q", "c3b4", "c3c4", "d1a4",
      "d1b1", "d1b3", "d1c1", "d1c2", "d1d2", "d1e1", "d1e2", "d1f1", "d3d4", "d8c7",
      "d8c8", "d8d7", "d8e8", "e3b6", "e3c1", "e3c5", "e3d2", "e3d4", "e3f2", "f7d6",
      "f7e5", "f7g5", "f7h8", "g1e1", "g1f1", "g1g2", "g1g3", "g1h1", "g4e2", "g4f3",
      "g4f5", "g4h3", "g4h5"
  );
}
...
TEST_F(MoveGenerationTest, HandlesEnpassant_WhitePawnOnE5) {
  ...
  expectLegalMoves(
      "a5b6", "a7a8q", "b5a3", "b5d4", "b5d6", "b7b8q", "c3b4", "c3c4", "c7b6", "c7b8",
      "c7c6", "c7c8", "d1a4", "d1b1", "d1b3", "d1c1", "d1c2", "d1d2", "d1e1", "d1e2",
      "d1f1", "d3d4", "e3b6", "e3c1", "e3c5", "e3d2", "e3d4", "e3f2", "e3f4", "e3g5",
      "e5d6", "f7d6", "f7d8", "f7g5", "f7h8", "g1e1", "g1f1", "g1g2", "g1g3", "g1h1",
      "g4e2", "g4f3", "g4f5", "g4h3", "g4h5"
  );
}
...
TEST_F(MoveGenerationTest, HandlesPositionWithManyPieceMoves) {
  ...
  expectLegalMoves(
      ...
      "h8e8", "h8f8", "h8g8", "h8h1", "h8h2", "h8h3", "h8h4", "h8h5", "h8h6", "h8h7"
  );
}
...
TEST_F(MoveGenerationTest, HandlesPositionWithMultipleQueens) {
  ...
  expectLegalMoves(
      "a8a1", "a8a2", "a8a3", "a8a4", "a8a5", "a8a6", "a8a7", "a8b7", "a8b8", "a8c6",
...
TEST_F(MoveGenerationTest, HandlesPositionWithMultiplePawnPromotions) {
  ...
  expectLegalMoves(
      "a2a3", "a2a4", "a7a8q", "a7b8q", "b3b4", "c2c3", "c2c4", "c6a4", "c6a8", "c6b5",
      "c6b7", "c6d5", "c6d7", "c6e4", "c6e8", "c6f3", "c6g2", "c6h1", "c7b8q", "c7c8q",
      "c7d8q", "d2a5", "d2b4", "d2c1", "d2c3", "d2e1", "d2e3", "d2f4", "d2g5", "d2h6",
      "d3b2", "d3b4", "d3c1", "d3c5", "d3e1", "d3e5", "d3f2", "d3f4", "d4a1", "d4a4",
      "d4b2", "d4b4", "d4b6", "d4c3", "d4c4", "d4c5", "d4d5", "d4e3", "d4e4", "d4e5",
      "d4f2", "d4f4", "d4f6", "d4g1", "d4g4", "d4h4", "d6b5", "d6b7", "d6c4", "d6c8",
      "d6e4", "d6e8", "d6f5", "d6f7", "e2e3", "e2e4", "e7d8q", "e7e8q", "e7f8q", "f1a1",
      "f1b1", "f1c1", "f1d1", "f1e1", "f1f2", "f1f3", "f1f4", "f1f5", "f1f6", "f1f7",
      "f1f8", "f1g1", "f1h1", "g3f2", "g3f3", "g3f4", "g3g2", "g3h2", "g3h4", "g7f8q",
      "g7g8q", "g7h8q", "h5a5", "h5b5", "h5c5", "h5d5", "h5e5", "h5f5", "h5g5", "h5h1",
      "h5h2", "h5h3", "h5h4", "h5h6", "h5h7", "h5h8"
  );
}
...
TEST_F(MoveGenerationTest, HandlesPinnedSlidingPiece_CanCapturePinner) {
  ...
  expectLegalMoves(
      "a1b2", "a1c3", "a1d4", "b5a3", "b5a7", "b5c3", "b5c7", "b5d4", "b5d6", "c2c1q",
      "c6a7", "c6b4", "c6b8", "c6d4", "c6d8", "c6e5", "c6e7", "d2d1q", "f3f2", "f5e4",
      "f5g6", "f7d7", "f7e7", "f7f6", "f7f8", "g7f6", "g7g5", "g7g6", "h2h1q", "h6h5",
      "h8b8", "h8c8", "h8d8", "h8e8", "h8f8", "h8g8"
  );
}
...
TEST_F(MoveGenerationTest, HandlesAvailableCastle_WhiteLongSide) {
  ...
  expectLegalMoves(
      "a7a5", "a7a6", "a8b8", "c8a6", "c8b7", "d7d5", "d7d6", "f7f5", "f7f6", "f8d8",
...
TEST_F(MoveGenerationTest, HandlesAvailableCastle_BlackShortSide) {
  ...
  expectLegalMoves(
      "a7a5", "a7a6", "a8b8", "b4a3", "b4a4", "b4a5", "b4b2", "b4b3", "b4b5", "b4b6",
...
TEST_F(MoveGenerationTest, HandlesWhiteKingCannotCastle_KnightAttackingCastlingLane) {
  ...
  expectLegalMoves(
      "a1b1", "a1c1", "a1d1", "a2a3", "a2a4", "b2b3", "b2b4", "b2c3", "c4c5", "d2b1",
...
TEST_F(MoveGenerationTest, Regression_BulkTestingEdgeCase) {
  ...
  expectLegalMoves(
      "a6a5", "b5a4", "b5b4", "b7a8", "c6a5", "c6a7", "c6b4", "c6b8", "c6d4", "c6e5",
