...
private:
  ...
  inline static constexpr std::array<Direction, static_cast<int>(NUM_DIRECTIONS)> directionReverse = {{
    Direction::E, Direction::W, Direction::S, Direction::N, Direction::SW, Direction::NE, Direction::SE, Direction::NW
  }};
...
public:
  ...
  static constexpr int numSqsInLane(Direction d, int square) noexcept { 
    ...
    switch (d) {
      ...
      case Direction::E: return 7-colIndex;
      case Direction::N: return rowIndex;
      case Direction::S: return 7-rowIndex;
      case Direction::NE: return std::min(rowIndex, 7-colIndex);
      case Direction::SW: return std::min(7-rowIndex, colIndex);
      case Direction::NW: return std::min(rowIndex, colIndex);
      case Direction::SE: return std::min(7-rowIndex, 7-colIndex);
      default: return 0;  // Instead of throwing, return 0 for invalid directions
    }
  }
};
