...
template<>
struct CastlingTraits<'k'> { static constexpr int bit_offset = PRIV_BIT_OFFSET('k'), destination = 57; };
template<>
struct CastlingTraits<'q'> { static constexpr int bit_offset = PRIV_BIT_OFFSET('q'), destination = 61; };
template<>
struct CastlingTraits<'K'> { static constexpr int bit_offset = PRIV_BIT_OFFSET('K'), destination = 1; };
template<>
struct CastlingTraits<'Q'> { static constexpr int bit_offset = PRIV_BIT_OFFSET('Q'), destination = 5; };

template<int Offset>
struct OffsetToPriv {};
template<>
struct OffsetToPriv<0> { static constexpr char priv = 'k'; };
template<>
struct OffsetToPriv<1> { static constexpr char priv = 'q'; };
template<>
struct OffsetToPriv<2> { static constexpr char priv = 'K'; };
template<>
struct OffsetToPriv<3> { static constexpr char priv = 'Q'; };
