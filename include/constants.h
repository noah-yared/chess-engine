...
inline constexpr int CASTLING_DESTINATION(char priv) {
  /**
...
inline constexpr int PRIV_BIT_OFFSET(char priv) {
  /**
...
inline constexpr std::pair<char, char> CASTLING_RIGHT_CHARS(Color c) {
...
inline u64 STARTING_PAWN_MASK(Color c) {
...
inline u64 PAWN_PROMOTION_RANK_MASK(Color c) {
