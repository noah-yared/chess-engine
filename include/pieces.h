...
concept Sliding = (pType == PieceType::QUEEN || pType == PieceType::ROOK || pType == PieceType::BISHOP);

template<PieceType pType>
concept NonSliding = (pType == PieceType::PAWN || pType == PieceType::KNIGHT || pType == PieceType::KING);
