...
constexpr std::array<u64, NUM_BITBOARDS> STARTING_BBS = {
    STARTING_BLACK_PAWNS,   STARTING_BLACK_ROOKS,   STARTING_BLACK_KNIGHTS, STARTING_BLACK_BISHOPS,
    STARTING_BLACK_QUEENS,  STARTING_BLACK_KINGS,   STARTING_WHITE_PAWNS,   STARTING_WHITE_ROOKS,
    STARTING_WHITE_KNIGHTS, STARTING_WHITE_BISHOPS, STARTING_WHITE_QUEENS,  STARTING_WHITE_KINGS};

constexpr u64 STARTING_WHITE_BB = STARTING_WHITE_PAWNS | STARTING_WHITE_ROOKS |
                                  STARTING_WHITE_KNIGHTS | STARTING_WHITE_BISHOPS |
                                  STARTING_WHITE_QUEENS | STARTING_WHITE_KINGS;

constexpr u64 STARTING_BLACK_BB = STARTING_BLACK_PAWNS | STARTING_BLACK_ROOKS |
                                  STARTING_BLACK_KNIGHTS | STARTING_BLACK_BISHOPS |
                                  STARTING_BLACK_QUEENS | STARTING_BLACK_KINGS;
